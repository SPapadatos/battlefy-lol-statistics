...
<html lang="en">
<head>
    <title>Code coverage report for lib/Endpoints/ChampionMasteryEndpoint.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/Endpoints/</a> ChampionMasteryEndpoint.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
    get(<span class="fstat-no" title="function not covered" >summonerID) {</span>
        const <span class="cstat-no" title="statement not covered" >self = this</span>
        /**
         * @name ChampionMastery.get.inner
         */
        return <span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >function(championID) {</span></span>
...
&nbsp;
     ...
     * @param {number} summonerID - The ID of the summoner.
     */
    list(<span class="fstat-no" title="function not covered" >summonerID) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
...
&nbsp;
     ...
     * @param {number} summonerID - The ID of the summoner.
     */
    totalScore(<span class="fstat-no" title="function not covered" >summonerID) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
