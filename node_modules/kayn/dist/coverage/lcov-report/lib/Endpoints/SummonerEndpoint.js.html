...
<html lang="en">
<head>
    <title>Code coverage report for lib/Endpoints/SummonerEndpoint.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/Endpoints/</a> SummonerEndpoint.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
     ...
     */
    summonerName(<span class="fstat-no" title="function not covered" >summonerName) {</span>
...
&nbsp;
     ...
     */
    summonerID(<span class="fstat-no" title="function not covered" >summonerID) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
