...
<html lang="en">
<head>
    <title>Code coverage report for lib/Endpoints/TournamentEndpoint.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/Endpoints/</a> TournamentEndpoint.js
    </h1>
    <div class='clearfix'>
...
163
164
165</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1×</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Endpoint from 'Endpoint'
...
&nbsp;
     ...
     */
    createTournamentCode(<span class="fstat-no" title="function not covered" >tournamentID, body) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
            'codes',
...
&nbsp;
     ...
     */
    updateTournamentCode(<span class="fstat-no" title="function not covered" >tournamentCode, body) {</span>
        if (<span class="cstat-no" title="statement not covered" >typeof body !== 'object')</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(</span>
                'The body of updateTournamentCode should have an object argument',
            )
        if (<span class="cstat-no" title="statement not covered" >Object.keys(body).length === 0)</span>
<span class="cstat-no" title="statement not covered" >            throw new Error(</span>
...
&nbsp;
     ...
     */
    getTournamentByCode(<span class="fstat-no" title="function not covered" >tournamentCode) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
            `codes/${tournamentCode}`,
...
&nbsp;
     ...
     */
    register(<span class="fstat-no" title="function not covered" >providerID, name = '') {</span>
        const <span class="cstat-no" title="statement not covered" >body = {</span>
            providerId: providerID,
        }
        if (<span class="cstat-no" title="statement not covered" >name.length &gt; 0) <span class="cstat-no" title="statement not covered" >body.name = name</span></span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
            'tournaments',
...
&nbsp;
     ...
     */
    registerProviderData(<span class="fstat-no" title="function not covered" >region = this.config.region.toUpperCase(), url) {</span>
        const <span class="cstat-no" title="statement not covered" >body = {</span>
...
&nbsp;
     ...
     */
    lobbyEvents(<span class="fstat-no" title="function not covered" >tournamentCode) {</span>
        return <span class="cstat-no" title="statement not covered" >new Request(</span>
            this.config,
            this.serviceName,
